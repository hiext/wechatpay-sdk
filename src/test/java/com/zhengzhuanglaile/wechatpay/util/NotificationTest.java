...
public class NotificationTest {
    ...
    private static final String        privateKey           = WechatPayRsaCrypUtil
    ...
    @Test
    public void check() throws ValidationException, ParseException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        String b = body;
        System.out.println(b);
        NotificationRequest notificationRequest = new NotificationRequest.Builder().withBody(body)
            .withNonce(WECHAT_PAY_NONCE)
            .withSerialNumber(WECHAT_PAY_SERIAL)
            .withSignature(WECHAT_PAY_SIGNATURE)
            .withTimestamp(WECHAT_PAY_TIMESTAMP)
            .build();
