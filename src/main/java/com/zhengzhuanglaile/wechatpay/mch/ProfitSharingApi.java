...
public class ProfitSharingApi {
     ...
     * @return
     */
    public ProfitSharingCreateOrderResult queryOrderState(ProfitSharingQueryParam param,
                                                          WechatPayConfig wechatPayConfig) {
        init();
     ...
     * @return
     */
    public ProfitSharingCreateOrderResult unfreeze(ProfitSharingUnfreezeParam param, WechatPayConfig wechatPayConfig) {
        init();
