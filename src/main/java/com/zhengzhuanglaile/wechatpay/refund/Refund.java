...
public class Refund extends WechatPayBaseResult {
    ...
    private List<RefundPromotion> promotionDetail = new ArrayList<RefundPromotion>();
    /**
     * 金额信息 说明：金额详细信息
     */
    ...
    /**
     * 资金账户 说明：退款所使用资金对应的资金账户类型 枚举值： - UNSETTLED : 未结算资金 - AVAILABLE : 可用余额 - UNAVAILABLE : 不可用余额 - OPERATION : 运营户 -
    ...
    public List<RefundPromotion> getPromotionDetail() {
        return promotionDetail;
    }

    public void setPromotionDetail(List<RefundPromotion> promotionDetail) {
